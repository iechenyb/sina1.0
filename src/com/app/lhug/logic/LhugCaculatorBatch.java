...
public class LhugCaculatorBatch {
	...
	static int bigBoucketSize = 40;// 大桶数据量
	...
	public static void enter() throws InterruptedException, ExecutionException{
		System.out.println("大赛成绩计算开始...");
	...
	public static void calAllSeasonLjdwjzWraper(String account, int season) throws IOException {
		...
		// long e = System.currentTimeMillis();
		// System.out.println(account+"-"+season+"共耗时：" + (e - s) / 1000 + "." +
		// (e - s) % 1000);

	}

	public static void calOneSeasonLjdwjz(String account, int season, boolean write) throws IOException {
