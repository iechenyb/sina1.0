...
<div class="box" id="login">
    <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true" style="width:400px;">

        <form:errors path="*" id="msg" style="width:170px;" cssClass="errors" element="div" htmlEscape="false" />
        ...
        <section class="row btn-row" style="position: relative;width: 200px;margin: 0px auto;left: -17px;">
