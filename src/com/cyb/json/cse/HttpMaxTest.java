...
//		CollectionFactory.buildBeans(100*10000);//10 5m  50 20m 100 50m
//	    FileUtils.overideString2File(com.alibaba.fastjson.JSONArray.toJSONString(CollectionFactory.getBeans()), "d:/data/jsonlist100.txt");	     
