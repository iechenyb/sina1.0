...
import com.cyb.json.bean.Group;
import com.cyb.json.bean.Weibo;
...
public class AliJsonUtils {
	public static void main(String[] args) {
		...
		map.put("empty", null);
		map.put("emptystr", "");
		System.out.println(net.sf.json.JSONArray.fromObject(map));
		...
		json2JavaBeanM4();// 将JSON文本转换为JavaBean的集合；转换为单纯的1个Object：parseObject(String
							// text, Class<T> clazz);
