...
public class BarcodeFactory {
    ...
    public static void main(String[] args) {  
    	String erweimapic = System.getProperty("user.dir")+"/"+UUIDUtils.getUUID()+".jpg";
    	String logo = System.getProperty("user.dir")+"/test.jpg";
    	System.out.println(erweimapic+","+logo);
        BarcodeFactory  
                .encode("http://coolshell.cn/articles/10590.html",  
                        300, 300, logo, erweimapic);  
    }  
}
