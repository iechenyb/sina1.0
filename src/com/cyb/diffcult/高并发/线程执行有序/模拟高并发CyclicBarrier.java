 ...
 * 创建时间: 2017年10月21日
 */
public class 模拟高并发CyclicBarrier {
	...
	Log log = LogFactory.getLog(模拟高并发CyclicBarrier.class);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for (int index = 0; index < conNums; index++) {//准备线程
			...
			VisitorWebClient visitor = new 模拟高并发CyclicBarrier().new VisitorWebClient(NO);
			exec.submit(visitor);
		}
