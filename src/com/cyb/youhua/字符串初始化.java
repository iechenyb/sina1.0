...
public class 字符串初始化 {
 public static void main(String[] args) {
	...
	//代码1  
	 ...
	 System.out.println(ssab == ssac);//true
	 System.out.println(ssac == ssad);//true
	 System.out.println(ssaf == ssae);//false
	 System.out.println(ssaf == ssab);//true
