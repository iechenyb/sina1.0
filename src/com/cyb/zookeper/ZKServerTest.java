...
public class ZKServerTest {
	Log log = LogFactory.getLog(ZKServerTest.class);
	/*private static ZooKeeper zookeeper;*/
	public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
		/*zookeeper = new ZooKeeper("localhost:2181",5000,new CreateSessionWatcher());
		...
		// 创建一个与服务器的连接
		 ...
		 // 取出子目录节点列表  https://www.cnblogs.com/ggjucheng/p/3370359.html
