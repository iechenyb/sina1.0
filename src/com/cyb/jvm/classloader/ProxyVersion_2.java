...
public class ProxyVersion_2 implements Serializable
{
    ...
    {    
        ...
        HelloWorld helloWorld = (HelloWorld)ProxyVersion_2.newProxyInstance(HelloWorld.class);
    ...
    public static Object newProxyInstance(Class<?> interfaces) throws Exception
    {
        ...
        sb.append("package com.cyb.compile;\n\n");
        sb.append("public class StaticProxy_2 implements HelloWorld\n");
        sb.append("{\n");
        sb.append("\t" + interfaces.getSimpleName() + " interfaces;\n\n");
        sb.append("\tpublic StaticProxy_2(" + interfaces.getSimpleName() +  " interfaces)\n");
        sb.append("\t{\n");
        ...
        String fileName = fileDir + "\\src\\com\\cyb\\compile\\StaticProxy_2.java";
        ...
        Class<?> c = ul.loadClass("com.cyb.compile.StaticProxy_2");
        
        /** 利用反射将c实例化出来 */
        Constructor<?> constructor = c.getConstructor(HelloWorld.class);
        
        HelloWorld helloWorldImpl = new HelloWorldImpl2();
