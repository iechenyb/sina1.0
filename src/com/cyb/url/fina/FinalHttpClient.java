...
public class FinalHttpClient {
	...
	public static String doGet(String uri) {
		...
		/*httpRequst.addHeader("Basic realm", "MY_OAUTH_REALM/client");
		httpRequst.addHeader("X-Content-Type-Options", "nosniff");
		httpRequst.addHeader("X-Frame-Options", "DENY");
		httpRequst.addHeader("X-XSS-Protection","1; mode=block");
		httpRequst.addHeader("Authorization","Bear KKOw9MPlY3JldA== ");*/
		try {
			...
			if (httpResponse.getStatusLine().getStatusCode() == 200) {
				...
				System.out.println("响应结果："+httpResponse.getStatusLine().getStatusCode()
	...
	public static List<NameValuePair> mapParams2ListPair(Map<String,String> params){
	...
	public static String doPost(String url,Map<String,String> params) {
		...
		try {
			httpRequst.setEntity(new UrlEncodedFormEntity(mapParams2ListPair(params), HTTP.UTF_8));
	...
	public static String doPost(String url,Map<String,String> para) {
		...
		HttpPost httpRequst = new HttpPost(url);// 创建HttpPost对象
		try {
			httpRequst.setEntity(new UrlEncodedFormEntity(mapParams2ListPair(para), HTTP.UTF_8));
			@SuppressWarnings("resource")
			HttpResponse httpResponse = new DefaultHttpClient().execute(httpRequst);
			if (httpResponse.getStatusLine().getStatusCode() == 200) {
				HttpEntity httpEntity = httpResponse.getEntity();
