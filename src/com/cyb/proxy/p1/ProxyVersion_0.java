...
public class ProxyVersion_0 implements Serializable
{
    ...
    {
        String src = "package com.cyb.proxy.p1;\n\n" + 
                     "public class StaticProxy_0 implements HelloWorld\n" + 
                     "{\n" + 
                     "\tHelloWorld helloWorld;\n\n" + 
                     "\tpublic StaticProxy_0(HelloWorld helloWorld)\n" + 
                     "\t{\n" + 
        ...
        String fileName = fileDir + "\\src\\com\\cyb\\proxy\\p1\\StaticProxy_0.java";
        ...
        Class<?> c = ul.loadClass("com.cyb.proxy.p1.StaticProxy_0");
        ...
        File classFile = new File(fileDir + "\\src\\com\\xrq\\proxy\\StaticProxy_0.class");
        javaFile.delete();
        classFile.delete();
