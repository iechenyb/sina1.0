...
public class LargeMappedFiles {  
    /** 
     ...
     public static void main(String[] args) throws IOException {  
      // 写入文件的路径   
      String filePath = FileUtils.getAbsolutePathAtClass(DivdTxt.class)+"456";  
      // 切分文件的路径   
      String sqlitFilePath = FileUtils.getAbsolutePathAtClass(DivdTxt.class)+"\\456\\123";  
      //数据的个数   
     ...
     public static void WriteData(String path,int CountNumbers) throws IOException {  
      ...
      for (int i = 0; i < CountNumbers; i++) {  //new Random().nextInt(Integer.MAX_VALUE)
       fw.write( i+ "\r\n");  
      }  
      fw.close();  
      fs.close();  
