...
public class PinyinUtils {
	Log log = LogFactory.getLog(PinyinUtils.class);
	public static void main(String[] args) {
		String name="不知道你要干啥子 iechenyb！";
		System.out.println(PinyinUtils.converterToFirstSpell(name));
		System.out.println(PinyinUtils.getAlpha(name));
		System.out.println(PinyinUtils.getPingYin(name));
