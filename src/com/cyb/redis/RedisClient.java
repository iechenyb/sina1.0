...
public class RedisClient {
    ...
    { 
        ...
        //Jedis db = new Jedis("127.0.0.1", port);
    } 
    ...
    { 
        ...
        shards.add(new JedisShardInfo(ComputerUtil.getRealIP(), port, "master")); 
